...
public class AddPriceDialog {
	...
	public AddPriceDialog(Display display) {
		super();
	...
	public void run() {
		...
		text3.setLayoutData(new RowData(100, SWT.DEFAULT));

		Button ok = new Button(shell, SWT.PUSH);
		ok.setText("Submit");

		DatabaseFunctions df = new DatabaseFunctions();
		ok.addSelectionListener(widgetSelectedAdapter(
				e -> df.savePrice(text1.getText(), text2.getText(), Integer.parseInt(text3.getText()))));
